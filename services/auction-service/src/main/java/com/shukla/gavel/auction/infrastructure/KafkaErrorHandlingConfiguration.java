...
/**
 * Poison-pill protection for the event listeners: without this, a message that fails
 ...
 * retries and go straight to the DLT. Reordering introduced by redelivery is harmless
 * here: the current-price update is monotonic (ADR 0010).
 */
@Configuration
